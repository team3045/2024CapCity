...
public class GremlinUtil {
     ...
     * @return returns whatever the value, position, velocity. etc, is after gearing is taken into account
     */
    ...
    /**
     * Clamp a value between a max and min, logging a fault if it is outside of the desired range.
